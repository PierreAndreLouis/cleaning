...
const features = [
  ...
  {
    id: 4,
    imgSrc: 'https://kahimm.com/wp-content/uploads/2024/02/cleaning--1200x801.jpg',
  ...
  {
    id: 5,
    imgSrc: 'https://www.winmar.ca/wp-content/uploads/2022/03/WINMAR-Deep_Cleaning-Secondary-2-600x450-1.jpg',
  ...
  {
    id: 6,
    imgSrc: 'https://kpmnettoyage.com/wp-content/uploads/2023/05/hauteurs-nettoyage-vitres-2.png',
          ...
          {features.map(feature => (
            <div className='bg-white shadow-lg dark:bg-slate-800 rounded-xl p-4'>
              ...
              <div>
                ...
                <p className="mt-1.5 text-md text-slate-600 leading-6 text-secondary-500  dark:text-gray-400">
                  {feature.description}
                </p>
                <p className='mt-3 text-yellow-400 font-semibold'>Read More</p>
              </div>
            </div>
