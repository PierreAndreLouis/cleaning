...
// Sample data
const images = [
    { id: 1, titre: "This is image 1", category: 'Filter 1', src: 'https://www.pronet-azur.com/ressources/images/bureau-nettoyage-personne-service-n_9df4_xl.webp' },
    { id: 2, titre: "This is image 2", category: 'Filter 2', src: 'https://www.pronet-azur.com/ressources/images/shutterstock-1393690481_fe61_xl.webp' },
    { id: 3, titre: "This is image 3", category: 'Filter 2', src: 'https://www.pronet-azur.com/ressources/images/personne-service-nettoyage-professi_8979_xl.webp' },
    { id: 4, titre: "This is image 4", category: 'Filter 2', src: 'https://www.pronet-azur.com/ressources/images/vue-personne-service-nettoyage-prof_ce1a_xl.webp' },
    { id: 5, titre: "This is image 5", category: 'Filter 3', src: 'https://www.pronet-azur.com/ressources/images/serviteur-homme-nettoyant-maison-23_c588_xl.webp' },
    { id: 6, titre: "This is image 6", category: 'Filter 3', src: 'https://www.pronet-azur.com/ressources/images/homme-faisant-service-nettoyage-dom_e437_xl.webp' },
    { id: 7, titre: "This is image 7", category: 'Filter 3', src: 'https://www.pronet-azur.com/ressources/images/lp-support-shutterstock-2094671245_7213_lg.webp' },
    { id: 8, titre: "This is image 8", category: 'Filter 3', src: 'https://www.pronet-azur.com/ressources/images/lp-support-shutterstock-1887369340_e88b_lg.webp' },
    { id: 9, titre: "This is image 9", category: 'Filter 3', src: 'https://www.pronet-azur.com/ressources/images/lp-support-shutterstock-235845361_3b3b_lg.webp' },
];
...
const Gallery5 = () => {
    ...
    return (
        <div className='bg-yellow-50 dark:bg-gray-900 py-10 pt-20 '>
            <div className=''>
                <h2 className="text-yellow-400  text-3xl font-bold text-center sm:text-3xl">Découvrez Nos Réalisations</h2>
