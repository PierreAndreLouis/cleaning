          ...
          <div className="container  h-full sm:p-10 xl:p-0 ">
            <header className="container px-4 lg:flex mt-10 items-center h-full lg:mt-0   ">
              <div className="w-full max-w-3xl mx-auto">
                <h1 className=" text-4xl lg:text-start lg:text-6xl  sm:text-5xl  font-bold text-gray-100 text-center dark:text-gray-200">
                ...
                <p className="text-lg lg:text-start pt-6 text-center mb-10 text-gray-400 dark:text-gray-300">
                  Vestibulum ultrices, la haine devient rhoncus vulputate, ex haine dignissim nibh, a posuere lectus massa vel nibh. Le football en direct sera suivi de peur et de temps.
                </p>
                <div className='w-full  flex'>
                  <button className="bg-yellow-400 lg:mx-0 mx-auto  text-black dark:text-gray-900 text-lg font-medium px-4 py-2 rounded shadow">
                    Learn More
                  </button>
                </div>
              </div>
